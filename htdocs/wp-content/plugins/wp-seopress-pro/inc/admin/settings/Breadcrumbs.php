...
add_settings_field(
    ...
    __('Post type to show in Breadcrumbs for taxonomies (archive)', 'wp-seopress-pro'), // Title
...
add_settings_field(
    ...
    __('Taxonomy to show in Breadcrumbs for post types (singular)', 'wp-seopress-pro'), // Title
