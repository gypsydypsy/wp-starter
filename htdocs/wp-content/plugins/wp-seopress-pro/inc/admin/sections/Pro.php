...
function seopress_print_pro_section($key)
{
	...
	$sections = [
		...
		'woocommerce' => [
			...
			'alert'  => /* translators: %s href + ID attributes */ sprintf(__('We also recommend <a class="nav-tab" %s>adding WooCommerce directives to your robots.txt</a> file to reduce your crawl budget.', 'wpseopress-pro'), 'id="tab_seopress_robots-tab" href="?page=seopress-pro-page#tab=tab_seopress_robots" style="
			margin: inherit;
            display: inline;
			padding: inherit;
		...
		'rewrite' => [
			...
			'desc'   => /* translators: %s admin URL of SEOPress advanced settings page */ sprintf(__('Change the URL rewriting. To remove the <strong>/category/</strong> or <strong>/product-category/</strong> in URL, <a href="%s">click here</a>.', 'wp-seopress-pro'), esc_url(admin_url('admin.php?page=seopress-advanced'))),
		],
		'white-label' => [
			'toggle' => 1,
