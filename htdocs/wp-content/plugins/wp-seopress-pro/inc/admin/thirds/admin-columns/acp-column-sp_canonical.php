...
class ACP_Column_sp_canonical extends AC\Column\Meta
	...
	public function editing() {
		return new ACP_Editing_Model_sp_canonical( $this );
	}

	public function sorting() {
		return new ACP_Sorting_Model_sp_canonical( $this );
	}

	public function export() {
		return new ACP_Export_Model_sp_canonical( $this );
	}
 ...
 */
class ACP_Editing_Model_sp_canonical extends \ACP\Editing\Model {
	...
	public function save( $id, $value ) {
		update_post_meta( $id, '_seopress_robots_canonical', esc_html( $value ) );
	}
 ...
 */
class ACP_Sorting_Model_sp_canonical extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_sp_canonical extends \ACP\Export\Model {
