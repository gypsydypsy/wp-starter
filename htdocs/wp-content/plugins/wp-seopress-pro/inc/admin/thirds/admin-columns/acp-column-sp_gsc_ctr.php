...
class ACP_Column_sp_gsc_ctr extends AC\Column\Meta
	...
	public function sorting() {
		return new ACP_Sorting_Model_sp_gsc_ctr( $this );
	}

	public function export() {
		return new ACP_Export_Model_sp_gsc_ctr( $this );
	}
 ...
 */
class ACP_Sorting_Model_sp_gsc_ctr extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_sp_gsc_ctr extends \ACP\Export\Model {
