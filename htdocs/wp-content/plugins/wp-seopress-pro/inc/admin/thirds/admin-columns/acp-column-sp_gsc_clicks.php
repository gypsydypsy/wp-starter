...
class ACP_Column_sp_gsc_clicks extends AC\Column\Meta
	implements \ACP\Sorting\Sortable, \ACP\Export\Exportable, \ACP\Search\Searchable {

	public function __construct() {
		$this->set_type( 'column-sp_gsc_clicks' );
		$this->set_group( 'seopress' );
		$this->set_label( __( 'Clicks', 'wp-seopress-pro' ) );
	}

	public function get_meta_key() {
		return '_seopress_search_console_analysis_clicks';
	}
	...
	public function sorting() {
		return new ACP_Sorting_Model_sp_gsc_clicks( $this );
	}

	public function export() {
		return new ACP_Export_Model_sp_gsc_clicks( $this );
	}
 ...
 */
class ACP_Sorting_Model_sp_gsc_clicks extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_sp_gsc_clicks extends \ACP\Export\Model {
