...
class ACP_Column_sp_target_kw extends AC\Column\Meta
	...
	public function editing() {
		return new ACP_Editing_Model_sp_target_kw( $this );
	}

	public function sorting() {
		return new ACP_Sorting_Model_sp_target_kw( $this );
	}

	public function export() {
		return new ACP_Export_Model_sp_target_kw( $this );
	}
 ...
 */
class ACP_Editing_Model_sp_target_kw extends \ACP\Editing\Model {
	...
	public function save( $id, $value ) {
		update_post_meta( $id, '_seopress_analysis_target_kw', esc_html( $value ) );
	}
 ...
 */
class ACP_Sorting_Model_sp_target_kw extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_sp_target_kw extends \ACP\Export\Model {
