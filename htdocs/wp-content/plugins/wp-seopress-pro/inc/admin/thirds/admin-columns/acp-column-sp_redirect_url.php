...
class ACP_Column_sp_redirect_url extends AC\Column\Meta
	implements \ACP\Editing\Editable, \ACP\Sorting\Sortable, \ACP\Export\Exportable, \ACP\Search\Searchable {

	public function __construct() {
		$this->set_type( 'column-sp_redirect_url' );
		$this->set_group( 'seopress' );
		$this->set_label( __( 'Redirect URL', 'wp-seopress-pro' ) );
	}

	public function get_meta_key() {
		return '_seopress_redirections_value';
	}
	...
	public function editing() {
		return new ACP_Editing_Model_sp_redirect_url( $this );
	}

	public function sorting() {
		return new ACP_Sorting_Model_sp_redirect_url( $this );
	}

	public function export() {
		return new ACP_Export_Model_sp_redirect_url( $this );
	}
 ...
 */
class ACP_Editing_Model_sp_redirect_url extends \ACP\Editing\Model {
	...
	public function save( $id, $value ) {
		update_post_meta( $id, '_seopress_redirections_value', esc_html( $value ) );
	}
 ...
 */
class ACP_Sorting_Model_sp_redirect_url extends \ACP\Sorting\Model {
 ...
 */
class ACP_Export_Model_sp_redirect_url extends \ACP\Export\Model {
