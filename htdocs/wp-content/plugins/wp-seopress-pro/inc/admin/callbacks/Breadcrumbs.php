...
<p class="description">
    <?php esc_html_e('To avoid duplicated schemas, don\'t enable this option if HTML Breadcrumbs is ON.', 'wp-seopress-pro'); ?>
</p>
<p class="description">
...
<select id="seopress_breadcrumbs_cpt"
    name="seopress_pro_option_name[seopress_breadcrumbs_cpt][<?php echo esc_attr($taxonomy->name); ?>][cpt]">
...
<select id="seopress_breadcrumbs_tax"
    name="seopress_pro_option_name[seopress_breadcrumbs_tax][<?php echo esc_attr($post_type->name); ?>][tax]">
