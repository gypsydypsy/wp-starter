...
<label for="seopress_mu_white_label_admin_header">
    ...
    <?php } ?>
    value="1"/>
    <?php esc_html_e('Remove all blocks except SEO management from the SEO dashboard including Onboarding, SEO News, Notifications Center, Get started, Go PRO, Go Insights, SEO Tools and more', 'wp-seopress-pro'); ?>
</label>
