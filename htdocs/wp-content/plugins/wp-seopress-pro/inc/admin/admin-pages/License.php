...
?>
                ...
                <p>
                    <a class="seopress-help"
                        href="<?php echo esc_url($docs['license']['license_errors']); ?>"
                        target="_blank">
            ...
            <table class="form-table" role="presentation">
                <tbody>
                    <tr valign="top">
                        ...
                        <td valign="top">
                            <input id="seopress_pro_license_key" name="seopress_pro_license_key" type="text" autocomplete="off" spellcheck="false" autocorrect="off" autocapitalize="off" class="regular-text" value="<?php esc_attr_e($selected); ?>" />
                            <p class="description">
