    ...
    <div class="col-right">
        <p>
            <label for="seopress_google_suggest_kw_meta">
                ...
                <?php echo seopress_tooltip(esc_html__('Google suggestions', 'wp-seopress-pro'), esc_html__('Enter a keyword, or a phrase, to find the top 10 Google suggestions instantly. This is useful if you want to work with the long tail technique.', 'wp-seopress-pro'), esc_html('my super keyword,another keyword,keyword')); ?>
            </label>
