...
<div class="seopress-notice">
    <p class="sp-schema-count" data-count="<?php echo $count; ?>">
        <?php
            /* translators: %d number of automatic schemas */
            printf( _n( 'You have <strong>%d</strong> automatic schema:', 'You have <strong>%d</strong> automatic schemas:', $count, 'wp-seopress-pro' ), number_format_i18n($count) );
        ?>
    </p>
</div>
...
<?php
    ...
    foreach ($sp_schemas_ids as $id) {
        ...
        if ('none' != $seopress_pro_rich_snippets_type || '' != $seopress_pro_rich_snippets_type) {
            echo '<p class="schema_type"><span class="label">' . esc_html__('Name:', 'wp-seopress-pro') . ' </span>' . get_the_title($id) . ' - <span class="label">' . esc_html__('Type:', 'wp-seopress-pro') . ' </span>' . $seopress_pro_rich_snippets_type;
        ...
        if ('articles' == $seopress_pro_rich_snippets_type) {
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_article_desc) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][desc]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][desc]" placeholder="' . esc_html__('The description of the article', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Description', 'wp-seopress-pro') . '" value="' . esc_html($check_article_desc) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_article_author) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][author]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][author]" placeholder="' . esc_html__('The author of the article', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Post author', 'wp-seopress-pro') . '" value="' . esc_html($check_article_author) . '" />
					</p>';
            }
            if ('manual_img_single' == $seopress_pro_rich_snippets_article_img) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][img]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][img]" placeholder="' . esc_html__('Select your image', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Image', 'wp-seopress-pro') . '" value="' . esc_html($check_article_img) . '" />
					</p>';
            }
            if ('manual_date_single' == $seopress_pro_rich_snippets_article_coverage_start_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_start_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_start_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Coverage Start Date', 'wp-seopress-pro') . '" value="' . esc_html($check_article_coverage_start_date) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_article_coverage_start_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_start_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_start_time]" placeholder="' . esc_html__('e.g. HH:MM', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Coverage Start Time', 'wp-seopress-pro') . '" value="' . esc_html($check_article_coverage_start_time) . '" />
					</p>';
            }
            if ('manual_date_single' == $seopress_pro_rich_snippets_article_coverage_end_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_end_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_end_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Coverage End Date', 'wp-seopress-pro') . '" value="' . esc_html($check_article_coverage_end_date) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_article_coverage_end_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_end_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][coverage_end_time]" placeholder="' . esc_html__('e.g. HH:MM', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Coverage End Time', 'wp-seopress-pro') . '" value="' . esc_html($check_article_coverage_end_time) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_article_speakable) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_article][speakable]" name="seopress_pro_schemas[' . $id . '][rich_snippets_article][speakable]" placeholder="' . esc_html__('e.g. post', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Speakable CSS Selector', 'wp-seopress-pro') . '" value="' . esc_html($check_article_speakable) . '" />
					</p>';
            }
        }
        ...
        if ('localbusiness' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_lb_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][name]" placeholder="' . esc_html__('e.g. My Local Business', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Name of your business', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_type) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][type]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][type]" placeholder="' . esc_html__('e.g. TravelAgency', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Select a business type', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_type) . '" />
					</p>';
            }
            if ('manual_img_single' == $seopress_pro_rich_snippets_lb_img) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_lb][img]_meta">
							' . esc_html__('Image', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][img]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][img]" placeholder="' . esc_html__('Select your image', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Select your image', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_img) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_street_addr) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][street_addr]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][street_addr]" placeholder="' . esc_html__('e.g. Place Bellevue', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Street Address', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_street_addr) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_city) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][city]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][city]" placeholder="' . esc_html__('e.g. Biarritz', 'wp-seopress-pro') . '" aria-label="' . esc_html__('City', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_city) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_state) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][state]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][state]" placeholder="' . esc_html__('e.g. Nouvelle Aquitaine', 'wp-seopress-pro') . '" aria-label="' . esc_html__('State', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_state) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_pc) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][pc]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][pc]" placeholder="' . esc_html__('e.g. 64200', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Postal code', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_pc) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_country) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][country]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][country]" placeholder="' . esc_html__('e.g. FR for France', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Country', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_country) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_lat) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][lat]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][lat]" placeholder="' . esc_html__('e.g. 43.4831389', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Latitude', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_lat) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_lon) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][lon]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][lon]" placeholder="' . esc_html__('e.g. -1.5630987', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Longitude', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_lon) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_website) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][website]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][website]" placeholder="' . get_home_url() . '" aria-label="' . esc_html__('URL', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_website) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_tel) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][tel]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][tel]" placeholder="' . esc_html__('e.g. +33501020304', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Telephone', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_tel) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_lb_price) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_lb][price]" name="seopress_pro_schemas[' . $id . '][rich_snippets_lb][price]" placeholder="' . esc_html__('e.g. $$, €€€, or ££££...', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Price range', 'wp-seopress-pro') . '" value="' . esc_html($check_lb_price) . '" />
					</p>';
            }
            echo '<p>
            ...
            foreach ($days as $key => $day) {
                ...
                echo '<label for="seopress_pro_schemas[' . $id . '][rich_snippets_lb][opening_hours][' . $key . '][open]">' . esc_html__('Closed all the day?', 'wp-seopress-pro') . '</label> ';
                ...
                echo '<label for="seopress_pro_schemas[' . $id . '][rich_snippets_lb][opening_hours][' . $key . '][am][open]">' . esc_html__('Open in the morning?', 'wp-seopress-pro') . '</label> ';
                ...
                echo '<label for="seopress_pro_schemas[' . $id . '][rich_snippets_lb][opening_hours][' . $key . '][pm][open]">' . esc_html__('Open in the afternoon?', 'wp-seopress-pro') . '</label> ';
        ...
        if ('faq' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_faq_q) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_faq][q]" name="seopress_pro_schemas[' . $id . '][rich_snippets_faq][q]" placeholder="' . esc_html__('Your question', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Question', 'wp-seopress-pro') . '" value="' . esc_html($check_faq_q) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_faq_a) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_faq][a]" name="seopress_pro_schemas[' . $id . '][rich_snippets_faq][a]" placeholder="' . esc_html__('Your answer', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Answer', 'wp-seopress-pro') . '" value="' . esc_html($check_faq_a) . '" />
					</p>';
            }
        }
        ...
        if ('courses' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_courses_title) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_courses][title]" name="seopress_pro_schemas[' . $id . '][rich_snippets_courses][title]" placeholder="' . esc_html__('The title of your lesson, course...', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Title', 'wp-seopress-pro') . '" value="' . esc_html($check_courses_title) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_courses_desc) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_courses][desc]" name="seopress_pro_schemas[' . $id . '][rich_snippets_courses][desc]" placeholder="' . esc_html__('Enter your course/lesson description', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Course description', 'wp-seopress-pro') . '" value="' . esc_html($check_courses_desc) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_courses_school) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_courses][school]" name="seopress_pro_schemas[' . $id . '][rich_snippets_courses][school]" placeholder="' . esc_html__('Name of university, organization...', 'wp-seopress-pro') . '" aria-label="' . esc_html__('School/Organization', 'wp-seopress-pro') . '" value="' . esc_html($check_courses_school) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_courses_offers) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_courses][offers]_meta">
							' . esc_html__('Course offers', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_courses][offers]" name="seopress_pro_schemas[' . $id . '][rich_snippets_courses][offers]" placeholder="' . esc_html__('Course offers', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Course offers', 'wp-seopress-pro') . '" value="' . esc_html($check_courses_offers) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_courses_instances) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_courses][instances]_meta">
							' . esc_html__('Course instances', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_courses][instances]" name="seopress_pro_schemas[' . $id . '][rich_snippets_courses][instances]" placeholder="' . esc_html__('Course instances', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Course instances', 'wp-seopress-pro') . '" value="' . esc_html($check_courses_instances) . '" />
					</p>';
            }
        }
        ...
        if ('recipes' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][name]" placeholder="' . esc_html__('The name of your dish', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Recipe name', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_desc) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][desc]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][desc]" placeholder="' . esc_html__('A short summary describing the dish.', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Short recipe description', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_desc) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_cat) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][cat]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][cat]" placeholder="' . esc_html__('e.g. appetizer, entree, or dessert', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Recipe category', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_cat) . '" />
					</p>';
            }
            if ('manual_img_single' == $seopress_pro_rich_snippets_recipes_img) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][img]_meta">
							' . esc_html__('Image', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][img]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][img]" placeholder="' . esc_html__('Select your image', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Image', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_img) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_video) {
                echo '<p>
                        ...
                        <input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][video]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][video]" placeholder="' . esc_html__('e.g. https://www.youtube.com/watch?v=p6v9Jd5lRIU', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Video URL of the recipe', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_video) . '" />
                    </p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_prep_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][prep_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][prep_time]" placeholder="' . esc_html__('e.g. 30', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Preparation time (in minutes)', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_prep_time) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_cook_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][cook_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][cook_time]" placeholder="' . esc_html__('e.g. 45', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Cooking time (in minutes)', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_cook_time) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_calories) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][calories]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][calories]" placeholder="' . esc_html__('Number of calories', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Calories', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_calories) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_recipes_yield) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][yield]" name="seopress_pro_schemas[' . $id . '][rich_snippets_recipes][yield]" placeholder="' . esc_html__('e.g. number of people served, or number of servings', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Recipe yield', 'wp-seopress-pro') . '" value="' . esc_html($check_recipes_yield) . '" />
					</p>';
            }
        ...
        if ('jobs' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][name]" placeholder="' . esc_html__('The title of the job (not the title of the posting). For example, "Software Engineer" or "Barista".', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Job title', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_desc) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][desc]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][desc]" placeholder="' . esc_html__('The full description of the job in HTML format.', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Job description', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_desc) . '" />
					</p>';
            }
            ...
            if ('manual_date_single' == $seopress_pro_rich_snippets_jobs_valid_through) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" autocomplete="false" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][valid_through]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][valid_through]" placeholder="' . esc_html__('The date when the job posting will expire in ISO 8601 format. For example, "2017-02-24" or "2017-02-24T19:33:17+00:00".', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Expiration date', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_valid_through) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_hiring_same_as) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][hiring_same_as]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][hiring_same_as]" placeholder="' . esc_html__('The organization website URL offering the job position.', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Organization URL', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_hiring_same_as) . '" />
					</p>';
            }
            if ('manual_img_single' == $seopress_pro_rich_snippets_jobs_hiring_logo) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][hiring_logo]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][hiring_logo]" placeholder="' . esc_html__('The organization logo offering the job position.', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Organization logo', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_hiring_logo) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_address_street) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][address_street]_meta">
							' . esc_html__('Street address', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][address_street]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][address_street]" placeholder="' . esc_html__('Street address', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Street address', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_address_street) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_address_locality) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][address_locality]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][address_locality]" placeholder="' . esc_html__('Locality address', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Locality address', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_address_locality) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_address_region) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][address_region]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][address_region]" placeholder="' . esc_html__('Region', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Region', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_address_region) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_postal_code) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][postal_code]_meta">
							' . esc_html__('Postal code', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][postal_code]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][postal_code]" placeholder="' . esc_html__('Postal code', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Postal code', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_postal_code) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_country) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][country]_meta">
							' . esc_html__('Country', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][country]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][country]" placeholder="' . esc_html__('Country', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Country', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_country) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_remote) {
                echo '<p>
						...
						<input type="checkbox" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][remote]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][remote]" placeholder="' . esc_html__('Remote job?', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Remote job?', 'wp-seopress-pro') . '"';
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_location_requirement) {
                echo '<p>
                    <label for="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][location_requirement]_meta">
                        ' . esc_html__('Location requirement for remote job', 'wp-seopress-pro') . '</label>
                    <input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][location_requirement]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][location_requirement]" placeholder="' . esc_html__('Location requirement for remote job', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Location requirement for remote job', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_location_requirement) . '" />
                </p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_direct_apply) {
                echo '<p>
						...
						<input type="checkbox" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][direct_apply]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][direct_apply]" placeholder="' . esc_html__('Direct apply?', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Direct apply?', 'wp-seopress-pro') . '"';
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_salary) {
                echo '<p>
						...
						<input type="number" step="0.01" min="0" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][salary]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][salary]" placeholder="' . esc_html__('50', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Salary', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_salary) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_jobs_salary_currency) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][salary_currency]" name="seopress_pro_schemas[' . $id . '][rich_snippets_jobs][salary_currency]" placeholder="' . esc_html__('Currency', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Currency', 'wp-seopress-pro') . '" value="' . esc_html($check_jobs_salary_currency) . '" />
					</p>';
            }
        ...
        if ('videos' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_videos_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_videos][name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_videos][name]" placeholder="' . esc_html__('The title of your video', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Video name', 'wp-seopress-pro') . '" value="' . esc_html($check_videos_name) . '" />
					</p>';
            }
            ...
            if ('manual_img_single' == $seopress_pro_rich_snippets_videos_img) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_videos][img]" name="seopress_pro_schemas[' . $id . '][rich_snippets_videos][img]" placeholder="' . esc_html__('Select your image', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Video thumbnail', 'wp-seopress-pro') . '" value="' . esc_html($check_videos_img) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_videos_url) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_videos][url]" name="seopress_pro_schemas[' . $id . '][rich_snippets_videos][url]" placeholder="' . esc_html__('e.g. https://example.com/video.mp4', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Video URL', 'wp-seopress-pro') . '" value="' . esc_html($check_videos_url) . '" />
					</p>';
            }
        }
        ...
        if ('events' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_events_type) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][type]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][type]" placeholder="' . esc_html__('Select your event type', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Event type', 'wp-seopress-pro') . '" value="' . esc_html($check_events_type) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_events_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][name]" placeholder="' . esc_html__('The name of your event', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Event name', 'wp-seopress-pro') . '" value="' . esc_html($check_events_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_desc) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][desc]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][desc]" placeholder="' . esc_html__('Enter your event description', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Event description', 'wp-seopress-pro') . '" value="' . esc_html($check_events_desc) . '" />
					</p>';
            }
            if ('manual_img_single' == $seopress_pro_rich_snippets_events_img) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][img]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][img]" placeholder="' . esc_html__('Select your image', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Image thumbnail', 'wp-seopress-pro') . '" value="' . esc_html($check_events_img) . '" />
					</p>';
            }
            if ('manual_date_single' == $seopress_pro_rich_snippets_events_start_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Start date', 'wp-seopress-pro') . '" value="' . esc_html($check_events_start_date) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_start_date_timezone) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_date_timezone]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_date_timezone]" placeholder="' . esc_html__('e.g. -4:00', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Timezone start date', 'wp-seopress-pro') . '" value="' . esc_html($check_events_start_date_timezone) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_events_start_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][start_time]" placeholder="' . esc_html__('e.g. HH:MM', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Start time', 'wp-seopress-pro') . '" value="' . esc_html($check_events_start_time) . '" />
					</p>';
            }
            if ('manual_date_single' == $seopress_pro_rich_snippets_events_end_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][end_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][end_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . esc_html__('End date', 'wp-seopress-pro') . '" value="' . esc_html($check_events_end_date) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_events_end_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][end_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][end_time]" placeholder="' . esc_html__('e.g. HH:MM', 'wp-seopress-pro') . '" aria-label="' . esc_html__('End time', 'wp-seopress-pro') . '" value="' . esc_html($check_events_end_time) . '" />
					</p>';
            }
            if ('manual_date_single' == $seopress_pro_rich_snippets_events_previous_start_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][previous_start_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][previous_start_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Previous start date', 'wp-seopress-pro') . '" value="' . esc_html($check_events_previous_start_date) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_events_previous_start_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][previous_start_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][previous_start_time]" placeholder="' . esc_html__('e.g. HH:MM', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Previous start time', 'wp-seopress-pro') . '" value="' . esc_html($check_events_previous_start_time) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_location_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_name]" placeholder="' . esc_html__('e.g. My Local Business name', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Location name', 'wp-seopress-pro') . '" value="' . esc_html($check_events_location_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_location_url) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_url]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_url]" placeholder="' . esc_html__('e.g. https://www.example.com', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Event website', 'wp-seopress-pro') . '" value="' . esc_html($check_events_location_url) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_location_address) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_address]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][location_address]" placeholder="' . esc_html__('e.g. 1 Avenue de l\'Imperatrice, 64200 Biarritz', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Location Address', 'wp-seopress-pro') . '" value="' . esc_html($check_events_location_address) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_offers_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_name]" placeholder="' . esc_html__('e.g. General admission', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Offer name', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_offers_cat) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_cat]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_cat]" placeholder="' . esc_html__('Select your offer category', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Offer category', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_cat) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_offers_price) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_price]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_price]" placeholder="' . esc_html__('e.g. 10', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Offer price', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_price) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_offers_price_currency) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_price_currency]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_price_currency]" placeholder="' . esc_html__('e.g. USD, EUR...', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Offer price currency', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_price_currency) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_offers_availability) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_availability]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_availability]" placeholder="' . esc_html__('e.g. InStock, SoldOut, PreOrder', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Availability', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_availability) . '" />
					</p>';
            }
            if ('manual_date_single' == $seopress_pro_rich_snippets_events_offers_valid_from_date) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_valid_from_date]" class="seopress-date-picker" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_valid_from_date]" placeholder="' . esc_html__('The date when tickets go on sale', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Valid From', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_valid_from_date) . '" />
					</p>';
            }
            if ('manual_time_single' == $seopress_pro_rich_snippets_events_offers_valid_from_time) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_valid_from_time]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_valid_from_time]" placeholder="' . esc_html__('The time when tickets go on sale', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Time', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_valid_from_time) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_offers_url) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_url]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][offers_url]" placeholder="' . esc_html__('e.g. https://www.example.com', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Website to buy tickets', 'wp-seopress-pro') . '" value="' . esc_html($check_events_offers_url) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_performer) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][performer]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][performer]" placeholder="' . esc_html__('e.g. Lana Del Rey', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Performer name', 'wp-seopress-pro') . '" value="' . esc_html($check_events_performer) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_organizer_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][organizer_name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][organizer_name]" placeholder="' . esc_html__('e.g. Apple', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Organizer name', 'wp-seopress-pro') . '" value="' . esc_html($check_events_organizer_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_organizer_url) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][organizer_url]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][organizer_url]" placeholder="' . esc_html__('e.g. https://www.example.com', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Organizer URL', 'wp-seopress-pro') . '" value="' . esc_html($check_events_organizer_url) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_events_status) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][status]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][status]" placeholder="' . esc_html__('e.g. EventCancelled', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Event status', 'wp-seopress-pro') . '" value="' . esc_html($check_events_status) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_events_attendance_mode) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_events][attendance_mode]" name="seopress_pro_schemas[' . $id . '][rich_snippets_events][attendance_mode]" placeholder="' . esc_html__('e.g. OfflineEventAttendanceMode', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Event attendance mode', 'wp-seopress-pro') . '" value="' . esc_html($check_events_attendance_mode) . '" />
        ...
        if ('products' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_product_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][name]" placeholder="' . esc_html__('The name of your product', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Product name', 'wp-seopress-pro') . '" value="' . esc_html($check_product_name) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_description) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][description]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][description]" placeholder="' . esc_html__('The description of the product', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Product description', 'wp-seopress-pro') . '" value="' . esc_html($check_product_description) . '" />
            ...
            if ('manual_img_single' == $seopress_pro_rich_snippets_product_img) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][img]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][img]" placeholder="' . esc_html__('Select your image', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Thumbnail', 'wp-seopress-pro') . '" value="' . esc_html($check_product_img) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_price) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][price]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][price]" placeholder="' . esc_html__('e.g. 30', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Product price', 'wp-seopress-pro') . '" value="' . esc_html($check_product_price) . '" />
            ...
            if ('manual_date_single' == $seopress_pro_rich_snippets_product_price_valid_date) {
                echo '<p>
						...
						<input type="text" class="seopress-date-picker" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][price_valid_date]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][price_valid_date]" placeholder="' . esc_html__('e.g. YYYY-MM-DD', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Product price valid until', 'wp-seopress-pro') . '" value="' . esc_html($check_product_price_valid_date) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_sku) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][sku]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][sku]" placeholder="' . esc_html__('e.g. 0446310786', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Product SKU', 'wp-seopress-pro') . '" value="' . esc_html($check_product_sku) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_global_ids) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][global_ids]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][global_ids]" placeholder="' . esc_html__('e.g. gtin8', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Product Global Identifiers type', 'wp-seopress-pro') . '" value="' . esc_html($check_product_global_ids) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_product_global_ids_value) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][global_ids_value]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][global_ids_value]" placeholder="' . esc_html__('e.g. 925872', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Product Global Identifiers', 'wp-seopress-pro') . '" value="' . esc_html($check_product_global_ids_value) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_product_brand) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][brand]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][brand]" placeholder="' . esc_html__('e.g. category', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Select a brand', 'wp-seopress-pro') . '" value="' . esc_html($check_product_brand) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_product_price_currency) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][currency]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][currency]" placeholder="' . esc_html__('e.g. USD, EUR', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Product currency', 'wp-seopress-pro') . '" value="' . esc_html($check_product_currency) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_condition) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][condition]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][condition]" placeholder="' . esc_html__('e.g. NewCondition, UsedCondition...', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Product Condition', 'wp-seopress-pro') . '" value="' . esc_html($check_product_condition) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_availability) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][availability]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][availability]" placeholder="' . esc_html__('e.g. InStock, InStoreOnly...', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Product Availability', 'wp-seopress-pro') . '" value="' . esc_html($check_product_availability) . '" />
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_product_positive_notes) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][positive_notes]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][positive_notes]" placeholder="' . esc_html__('e.g. Great design', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Positive Notes', 'wp-seopress-pro') . '" value="' . esc_html($check_product_pros) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_product_negative_notes) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_product][negative_notes]" name="seopress_pro_schemas[' . $id . '][rich_snippets_product][negative_notes]" placeholder="' . esc_html__('e.g. Too expensive', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Negative Notes', 'wp-seopress-pro') . '" value="' . esc_html($check_product_cons) . '" />
					</p>';
            }
        }
        ...
        if ('services' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_service_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][name]" placeholder="' . esc_html__('The name of your service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Service name', 'wp-seopress-pro') . '" value="' . esc_html($check_service_name) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_service_type) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][type]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][type]" placeholder="' . esc_html__('The type of service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Service type', 'wp-seopress-pro') . '" value="' . esc_html($check_service_type) . '" />
					</p>';
            }
            ...
            if ('manual_img_single' == $seopress_pro_rich_snippets_service_img) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_service][img]_meta">
							' . esc_html__('Thumbnail', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][img]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][img]" placeholder="' . esc_html__('Select your image', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Image', 'wp-seopress-pro') . '" value="' . esc_html($check_service_img) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_service_area) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][area]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][area]" placeholder="' . esc_html__('The area served by your service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Area served', 'wp-seopress-pro') . '" value="' . esc_html($check_service_area) . '" />
					</p>';
            }
            ...
            if ('manual_img_single' == $seopress_pro_rich_snippets_service_lb_img) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][lb_img]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][lb_img]" placeholder="' . esc_html__('Select your location image', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Location image', 'wp-seopress-pro') . '" value="' . esc_html($check_service_lb_img) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_service_slogan) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][slogan]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][slogan]" placeholder="' . esc_html__('The slogan of your service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Slogan', 'wp-seopress-pro') . '" value="' . esc_html($check_service_slogan) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_service_city) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_service][city]_meta">
							' . esc_html__('City', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][city]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][city]" placeholder="' . esc_html__('The city of your service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('City', 'wp-seopress-pro') . '" value="' . esc_html($check_service_city) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_service_state) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_service][state]_meta">
							' . esc_html__('State', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][state]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][state]" placeholder="' . esc_html__('The state of your service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('State', 'wp-seopress-pro') . '" value="' . esc_html($check_service_state) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_service_pc) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_service][pc]_meta">
							' . esc_html__('Postal code', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][pc]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][pc]" placeholder="' . esc_html__('The postal code of your service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Postal code', 'wp-seopress-pro') . '" value="' . esc_html($check_service_pc) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_service_country) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_service][country]_meta">
							' . esc_html__('Country', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][country]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][country]" placeholder="' . esc_html__('The country of your service (ISO format)', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Country', 'wp-seopress-pro') . '" value="' . esc_html($check_service_country) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_service_lat) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_service][lat]_meta">
							' . esc_html__('Latitude', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][lat]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][lat]" placeholder="' . esc_html__('The latitude of your service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Latitude', 'wp-seopress-pro') . '" value="' . esc_html($check_service_lat) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_service_lon) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_service][lon]_meta">
							' . esc_html__('Longitude', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][lon]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][lon]" placeholder="' . esc_html__('The longitude of your service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Longitude', 'wp-seopress-pro') . '" value="' . esc_html($check_service_lon) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_service_tel) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_service][tel]_meta">
							' . esc_html__('Telephone', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][tel]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][tel]" placeholder="' . esc_html__('The telephone of your service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Telephone', 'wp-seopress-pro') . '" value="' . esc_html($check_service_tel) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_service_price) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_service][price]_meta">
							' . esc_html__('Price range', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_service][price]" name="seopress_pro_schemas[' . $id . '][rich_snippets_service][price]" placeholder="' . esc_html__('The price range of your service', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Price range', 'wp-seopress-pro') . '" value="' . esc_html($check_service_price) . '" />
					</p>';
            }
        }
        ...
        if ('softwareapp' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_softwareapp_name) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_softwareapp][name]" name="seopress_pro_schemas[' . $id . '][rich_snippets_softwareapp][name]" placeholder="' . esc_html__('The name of your app', 'wp-seopress-pro') . '" aria-label="' . esc_html__('App name', 'wp-seopress-pro') . '" value="' . esc_html($check_softwareapp_name) . '" />
					</p>';
            }
            ...
            if ('manual_single' == $seopress_pro_rich_snippets_softwareapp_price) {
                echo '<p>
						...
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_softwareapp][price]" name="seopress_pro_schemas[' . $id . '][rich_snippets_softwareapp][price]" placeholder="' . esc_html__('The price of your app (set "0" if the app is free of charge)', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Price', 'wp-seopress-pro') . '" value="' . esc_html($check_softwareapp_price) . '" />
					</p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_softwareapp_currency) {
                echo '<p>
						<label for="seopress_pro_schemas[' . $id . '][rich_snippets_softwareapp][currency]_meta">
							' . esc_html__('Currency', 'wp-seopress-pro') . '</label>
						<input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_softwareapp][currency]" name="seopress_pro_schemas[' . $id . '][rich_snippets_softwareapp][currency]" placeholder="' . esc_html__('Currency', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Currency', 'wp-seopress-pro') . '" value="' . esc_html($check_softwareapp_currency) . '" />
					</p>';
            }
            if ('manual_rating_single' == $seopress_pro_rich_snippets_softwareapp_rating) {
                ...
                <input type="number" step="0.1" min="1" id="seopress_pro_schemas[' . $id . '][rich_snippets_softwareapp][rating]" name="seopress_pro_schemas[' . $id . '][rich_snippets_softwareapp][rating]" placeholder="' . esc_html__('The item rating', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Your rating', 'wp-seopress-pro') . '" value="' . esc_attr($check_softwareapp_rating) . '" />
                </p>';
            }
        ...
        if ('review' == $seopress_pro_rich_snippets_type) {
            if ('manual_single' == $seopress_pro_rich_snippets_review_item) {
                ...
                <input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_review][item]" name="seopress_pro_schemas[' . $id . '][rich_snippets_review][item]" placeholder="' . esc_html__('The item name reviewed', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Review item name', 'wp-seopress-pro') . '" value="' . esc_html($check_review_item) . '" />
                </p>';
            }
            ...
            if ('manual_img_single' == $seopress_pro_rich_snippets_review_img) {
                ...
                <input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_review][img]" name="seopress_pro_schemas[' . $id . '][rich_snippets_review][img]" placeholder="' . esc_html__('Select your image', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Review item image', 'wp-seopress-pro') . '" value="' . esc_html($check_review_img) . '" />
                </p>';
            }
            if ('manual_rating_single' == $seopress_pro_rich_snippets_review_rating) {
                ...
                ' . esc_html__('Your rating', 'wp-seopress-pro') . '</label>
                <input type="number" step="0.1" min="1" id="seopress_pro_schemas[' . $id . '][rich_snippets_review][rating]" name="seopress_pro_schemas[' . $id . '][rich_snippets_review][rating]" placeholder="' . esc_html__('The item rating', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Your rating', 'wp-seopress-pro') . '" value="' . esc_attr($check_review_rating) . '" />
                </p>';
            }
            if ('manual_rating_single' == $seopress_pro_rich_snippets_review_max_rating) {
                ...
                ' . esc_html__('Max best rating', 'wp-seopress-pro') . '</label>
                <input type="number" step="0.1" min="1" id="seopress_pro_schemas[' . $id . '][rich_snippets_review][max_rating]" name="seopress_pro_schemas[' . $id . '][rich_snippets_review][max_rating]" placeholder="' . esc_html__('Max best rating', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Max best rating', 'wp-seopress-pro') . '" value="' . esc_attr($check_review_max_rating) . '" />
                </p>';
            }
            if ('manual_single' == $seopress_pro_rich_snippets_review_body) {
                echo '<p>
                        ...
                        <input type="text" id="seopress_pro_schemas[' . $id . '][rich_snippets_review][body]" name="seopress_pro_schemas[' . $id . '][rich_snippets_review][body]" placeholder="' . esc_html__('Review body', 'wp-seopress-pro') . '" aria-label="' . esc_html__('Your review body', 'wp-seopress-pro') . '" value="' . esc_html($check_review_body) . '" />
                    </p>';
            }
        }
        ...
        if ('custom' == $seopress_pro_rich_snippets_type) {
            if ('manual_custom_single' == $seopress_pro_rich_snippets_custom) {
                echo '<p>
						...
						<textarea rows="25" id="seopress_pro_schemas[' . $id . '][rich_snippets_custom][custom]" name="seopress_pro_schemas[' . $id . '][rich_snippets_custom][custom]" placeholder="' . esc_html__('e.g. <script type="application/ld+json">{
