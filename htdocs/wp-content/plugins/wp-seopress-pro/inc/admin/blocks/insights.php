	...
	<div class="seopress-card-content">
		...
		?>
			<div class="wrap-seopress-tab-content">
				...
				<div id="tab_seopress_analytics"
					class="seopress-tab seopress-analytics <?php if ('tab_seopress_analytics' == $current_tab) {
						echo 'active';
					} ?>">
				...
				<?php if (seopress_get_toggle_option('google-analytics')) { ?>
				<div id="tab_seopress_matomo"
					class="seopress-tab seopress-analytics <?php if ('tab_seopress_matomo' == $current_tab) {
						echo 'active';
					} ?>">
				...
				<div id="tab_seopress_ps" class="seopress-tab seopress-page-speed inside<?php if ('tab_seopress_ps' == $current_tab) {
					...
					<?php } else {  ?>
					<p><?php esc_html_e('No data available.', 'wp-seopress-pro'); ?>
					</p>
					<?php } ?>
					<p>
				...
				<div id="tab_seopress_gsc" class="seopress-tab seopress-gsc inside<?php if ('tab_seopress_gsc' == $current_tab) {
					...
					<div class="seopress-card-title">
						...
						<div>
							...
							<p>
								<?php printf(esc_html__('How visitors find your site on Google', 'wp-seopress-pro'), $date_range); ?>
							</p>
						</div>
					</div>
						...
						<div>
							...
							<p>
								<?php
									...
									printf(esc_html__('By clicks in the past %s', 'wp-seopress-pro'), $date_range);
								?>
							</p>
						</div>
					</div>
											...
											<div class="gsc-item">
												...
												<div>
													<div class="seopress-summary-item">
														...
														<div class="seopress-summary-item-data">
															<?php echo get_post_meta($post_id, '_seopress_search_console_analysis_clicks', true); ?>
														</div>
													</div>
												</div>
											</div>
