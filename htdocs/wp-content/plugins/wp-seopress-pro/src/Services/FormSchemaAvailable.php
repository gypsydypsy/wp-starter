        ...
        return [
                    ...
                    [
                        ...
                        'html' => '
                            <ul>
                                ...
                                <li>
                                    ' . __('<strong>Do not include promotional elements in the name.</strong>', 'wp-seopress-pro') . "
                                </li>
                                <ul>
                                    <li>
            ...
            [
                ...
                'notices' => [
                    [
                        'type' => 'info',
                        'html' => '<p>' . sprintf(__('Build your custom schema. Don\'t forget to include the script tag: %s', 'wp-seopress-pro'), $pre) . '</p>',
                    ],
                ],
            ],
        ];
