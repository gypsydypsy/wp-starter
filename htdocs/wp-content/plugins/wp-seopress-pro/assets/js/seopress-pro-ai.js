        ...
        generateAltText: function (postId, lang = '') {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        const textarea = document.querySelector('#attachment-details-two-column-alt-text, #attachment-details-alt-text');

                        if (!textarea) console.log('Alternative text input could not be found.');
