jQuery(document).ready(function ($) {
    ...
    if (typeof hash != 'undefined') {
        ...
        if (typeof sessionStorage != 'undefined') {
            ...
            if (clean_hash[1] == '1') { //WooCommerce Tab
                ...
                $('#tab_seopress_inspect_url-tab').addClass("nav-tab-active");
                $('#tab_seopress_inspect_url').addClass("active");
            } else if (clean_hash[1] == '17') { //AI Tab
                $('#tab_seopress_ai-tab').addClass("nav-tab-active");
                $('#tab_seopress_ai').addClass("active");
            } else if (clean_hash[1] == '18') { //Alerts Tab
                $('#tab_seopress_alerts-tab').addClass("nav-tab-active");
                $('#tab_seopress_alerts').addClass("active");
    ...
    $("#seopress-tabs").find("a.nav-tab").click(function (e) {
        ...
        if (clean_hash[1] == 1) {
            ...
            sessionStorage.setItem("seopress_woocommerce_tab", 'tab_seopress_edd');
        } else if (clean_hash[1] == 14) {
            sessionStorage.setItem("seopress_woocommerce_tab", 'tab_seopress_rewrite');
        } else if (clean_hash[1] == 15) {
            sessionStorage.setItem("seopress_woocommerce_tab", 'tab_seopress_white_label');
        } else if (clean_hash[1] == 16) {
            sessionStorage.setItem("seopress_woocommerce_tab", 'tab_seopress_inspect_url');
        } else {
    ...
    //Robots
    $('#seopress-tag-robots-1, #seopress-tag-robots-2, #seopress-tag-robots-3, #seopress-tag-robots-6, #seopress-tag-robots-7, #seopress-tag-robots-8, #seopress-tag-robots-9, #seopress-tag-robots-10, #seopress-tag-robots-11, #seopress-tag-robots-12, #seopress-tag-robots-13').click(function () {
    ...
    const array_placeholder = [
        "#seopress_rich_snippets_publisher_logo",
    ];
    ...
    $('#seopress_rich_snippets_publisher_logo_upload').click(function (e) {
        ...
        mediaUploader.on('select', function () {
            ...
            $('#seopress_rich_snippets_publisher_logo_src').attr('src', attachment.url);

            $("#seopress_rich_snippets_publisher_logo_placeholder_src").attr('src', $("#seopress_rich_snippets_publisher_logo_meta").val());
        });
