...
jQuery(document).ready(function ($) {
    ...
    $(".box-schema-item").each(function (key) {
        ...
        seopress_call_offers_accordion(key);
        seopress_call_instances_accordion(key);
    });
    ...
    $(document).on("click", ".js-handle-snippet-type", function (event) {
        ...
        $(this).parent().parent().parent().find(".wrap-rich-snippets-item").toggle();
        ...
        function (e) {
            ...
            switch (value_select_classes) {
                ...
                case "course":
                    ...
                    bindAddOffer(number);
                    bindAddInstance(number);
                    seopress_call_offers_accordion(number);
                    seopress_call_instances_accordion(number);
                    break;
                case "faq":
                    bindAddFaq(number);
    ...
    function bindAddOffer(number) {
        const selector = ".box-schema-item[data-key='" + number + "'] #wrap-offers";
        if ($(selector).length === 0) {
            return;
        }

        // Offer
        const template = $(".box-schema-item[data-key='" + number + "'] #wrap-offers .offer:last").clone();

        // define counter
        let sectionsCount = $("#wrap-offers").attr("data-count");

        // add new section
        $(".box-schema-item[data-key='" + number + "'] #add-offer").click(
            function (e) {
                e.preventDefault();
                ...
                //inject new section
                section.appendTo(
                    ".box-schema-item[data-key='" + number + "'] #wrap-offers"
                );
        ...
        //remove section
        $(".box-schema-item[data-key='" + number + "'] #wrap-offers").on(
            "click",
            ".remove-offer",
            function () {
                //fade out section
    ...
    function bindAddInstance(number) {
        const selector = ".box-schema-item[data-key='" + number + "'] #wrap-instances";
        if ($(selector).length === 0) {
            return;
        }

        // Instance
        const template = $(".box-schema-item[data-key='" + number + "'] #wrap-instances .instance:last").clone();

        // define counter
        let sectionsCount = $("#wrap-instances").attr("data-count");

        // add new section
        $(".box-schema-item[data-key='" + number + "'] #add-instance").click(
            function (e) {
                e.preventDefault();
                ...
                //inject new section
                section.appendTo(
                    ".box-schema-item[data-key='" + number + "'] #wrap-instances"
                );
        ...
        //remove section
        $(".box-schema-item[data-key='" + number + "'] #wrap-instances").on(
            "click",
            ".remove-instance",
            function () {
                //fade out section
