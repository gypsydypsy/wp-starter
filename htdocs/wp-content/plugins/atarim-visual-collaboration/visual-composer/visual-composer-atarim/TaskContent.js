...
const IconContainer = styled.div`
    ...
    align-items: center;
    justify-content: center;
    backgroundColor: rgb(59 54 106 / 50%);
    transition: all 0.3s ease-out;
    &:hover: {
        opacity: 1;
    },
...
export default function TaskContent(props) {
  const {
    ...
    React.useEffect(() => {
        setIsInternal(selectedTask?.is_internal)
        return () => undefined;
    }, [selectedTask]);
                ...
                return (
                    <CommentLinkWrapper>
                        ...
                        <FiDownload
                            ...
                            // onClick={() => handleDownloadFromLink(comment.comments)} 
                            title="download file"
                        />
                    </CommentLinkWrapper>
                );
                ...
                return (
                    <ImageContainer>
                        ...
                        {/* <IconContainer>
                            ...
                            >
                                <OpenInNewIcon
                                    onClick={() => setEnlargeImage(comment.comments)}
                                    className={classes.openInNewIconTag}
                                />
                            </HtmlTooltip>
                            <HtmlTooltip 
                                title={
                            ...
                            >
                                <FiTrash2
                                    ...
                                    onClick={() => {
                                        ...
                                        setDeleteFilepath(comment.comments); 
            ...
            case "normal_text":
                return (
                    ...
                    >
                        ...
                        ></div>
                        {/* {
                            comment.comment_type === "normal_text" && comment.is_edited && !comment.is_deleted &&
                            <div
                                className={classes.commentEditedContainer}    
                            >
                                <HtmlTooltip title={<>{comment.updated_at}</>}>
                                    <div className={classes.commentEdited}>Edited</div>
                                </HtmlTooltip>
                            </div>
                        } */}
                    </div>
    ...
    const startInternalTask = () => {
        let commentData = {
          ...
          postData(commentUpdateDetails, commentData).then(res=>{
            if (res.status) {
              handleUpdateTaskComment(res.task,true,"internal",commentData.internal)   
            }
          })
    }
                    ...
                    <Comment key={i} >
                        {
                            ...
                            <CommentNormal>
                                {/* <AvatarWrapper>
                                    <AvatarImage src='https://wpfeedback-image.s3.us-east-2.amazonaws.com/uploads/user_22/avatar/1640091054_VitoZoomed.png' alt='avatar'/>
                                </AvatarWrapper> */}
                                <AvatarTextWrapper>
                                    <AvatarText>
                                        {
