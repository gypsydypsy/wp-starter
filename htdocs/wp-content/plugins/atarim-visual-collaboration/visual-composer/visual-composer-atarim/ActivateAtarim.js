...
export default function ActivateAtarim(props) {
  const {
    pluginData,
    textDesc,
    buttonText,
  ...
  return (
    <>
        ...
        >
            <InstallWrapper>
                <TextHeader>
                    Activate Atarim On This Website
                </TextHeader>
                <TextContent>
                    {textDesc}
                </TextContent>
                <CommentButton
                        onClick={()=>window.location.href = `${pluginData.url}${buttonLink}`}
                >
                    {buttonText}
                </CommentButton>
                <div
                ...
                >
                    <video  autoPlay loop >
                    <source src="https://wpfeedback-image.s3.us-east-2.amazonaws.com/public_videos/Atarim+Welcome+Plugin+version.mp4" type="video/mp4"/>
                    </video>
                </div>
                <PowerByWraper>
