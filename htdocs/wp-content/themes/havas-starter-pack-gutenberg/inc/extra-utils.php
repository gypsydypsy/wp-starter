...
if ( ! function_exists( 'havas_starter_pack_set_image_meta_upon_image_upload' ) ):
	/**
	 * Set alt/title/caption/description automatically when uploading a picture (based on the filename)
	 */
	function havas_starter_pack_set_image_meta_upon_image_upload( $post_ID ) {
...
if ( ! function_exists( 'havas_starter_pack_get_ip' ) ) :
	/**
	 * Get the ip
	 *
	 * @return mixed
	 */
	function havas_starter_pack_get_ip() {
...
if ( ! function_exists( 'havas_starter_pack_verify_google_recaptcha' ) ) :
	/**
	 * Verify a captcha response
	 */
	function havas_starter_pack_verify_google_recaptcha( $captcha_response ) {
