...
tarteaucitron.services.iframe = {
    ...
    "js": function () {
        ...
        tarteaucitron.fallback(['tac_iframe'], function (x) {
            ...
            return '<iframe src="' + url + '" width="' + width + '" height="' + height + '" style="border:0;overflow:hidden;" allowtransparency allowfullscreen></iframe>';
        });
    },
    "fallback": function () {
        "use strict";
    ...
    "js": function () {
        ...
        tarteaucitron.fallback(['amazon_product'], function (x) {
            var amazonId = x.getAttribute("amazonid"),
                ...
                iframe = '<iframe style="width:120px;height:240px;border:0;overflow:hidden;" marginwidth="0" marginheight="0" src="' + url + '"></iframe>';
    ...
    "js": function () {
        ...
        tarteaucitron.fallback(['dailymotion_player'], function (x) {
            var video_id = x.getAttribute("data-videoID"),
                ...
                params = 'info=' + x.getAttribute("data-showinfo") + '&autoPlay=' + x.getAttribute("data-autoplay");
            ...
            video_frame = '<iframe title="' +  title + '" src="//www.dailymotion.com/embed/video/' + video_id + '?' + params + '" ' + frame_width + frame_height + ' frameborder="0" allowfullscreen></iframe>';
            return video_frame;
        });
    }, 
    "fallback": function () {
...
tarteaucitron.services.datingaffiliation = {
    ...
    "js": function () {
        ...
        tarteaucitron.fallback(['datingaffiliation-canvas'], function (x) {
            ...
            return '<iframe src="' + url + '&r=' + r + '&p=' + p + '&cf0=' + cf0 + '&langue=' + langue + '&forward_affiliate=' + forward_affiliate + '&cf2=' + cf2 + '&cfsa2=' + cfsa2 + '" width="' + width + '" height="' + height + '" style="overflow:hidden; border:0;" marginheight="0" marginwidth="0"></iframe>';
        });
    },
    "fallback": function () {
        "use strict";
    ...
    "js": function () {
        ...
        tarteaucitron.fallback(['vimeo_player'], function (x) {
            var video_width = x.getAttribute("data-width") || x.getAttribute("width"),
                ...
                video_profile = x.getAttribute("data-profile") || x.getAttribute("profile") || '',
            ...
            if (video_profile.length > 0) {
                if (video_qs.length > 0) {
                    video_qs += "&";
                }
                video_qs += "profile=" + video_profile;
            }
            ...
            video_frame = '<iframe title="' + video_title + '" src="//player.vimeo.com/video/' + video_id + video_qs + '" ' + frame_width + frame_height + ' frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
...
tarteaucitron.services.youtube = {
    ...
    "js": function () {
        ...
        tarteaucitron.fallback(['youtube_player'], function (x) {
            ...
            video_frame = '<iframe title="' + title + '"type="text/html" ' + frame_width + frame_height + ' src="//www.youtube-nocookie.com/embed/' + video_id + '?' + params + '" frameborder="0" allowfullscreen></iframe>';
            return video_frame;
        });
    },
    "fallback": function () {
