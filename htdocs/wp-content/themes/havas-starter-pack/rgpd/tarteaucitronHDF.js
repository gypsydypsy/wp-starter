...
tarteaucitron.addService = function (serviceId) {
    ...
    if (tarteaucitron.added[service.key] !== true) {
        ...
        html += '       <h4 class="tarteaucitronH3" role="heading">' + service.name + '</h4>';
        // html += '       <span id="tacCL' + service.key + '" class="tarteaucitronListCookies"></span><br/>';
        if (tarteaucitron.parameters.moreInfoLink == true) {
            html += '       <ul><li><a href="https://opt-out.ferank.eu/service/' + service.key + '/" target="_blank" rel="noopener" title="' + tarteaucitron.lang.cookieDetail + ' ' + service.name + ' ' + tarteaucitron.lang.newWindow + '">';
            html += '           ' + tarteaucitron.lang.more;
            html += '       </a></li>';
            html += '       <li><a href="' + service.uri + '" target="_blank" rel="noopener" title="'+tarteaucitron.lang.ourSite + ' ' + service.name + ' ' + tarteaucitron.lang.newWindow + '">';
        ...
        html += '           <label class="tarteaucitronLabelCheckBox" for="' + service.key + '" tabindex="0" onkeydown="if (event.key === \'Enter\' || event.key === \' \') document.getElementById(\'' + service.key + '\').click();" role="switch"><span class="allowTxt">' + tarteaucitron.lang.allow + '</span><span class="denyTxt">';
...
tarteaucitron.load = function (ele) {
    ...
    tarteaucitron.addScript(pathToLang, '', function () {
        ...
        tarteaucitron.addScript(pathToServices, '', function () {
            ...
            html += '           <span class="visuallyHidden">' + tarteaucitron.lang.close + '</span>';
            html += '       </button>';
            html += '   <div id="tarteaucitronServices">';
            html += '      <div class="tarteaucitronLine tarteaucitronMainLine" id="tarteaucitronMainLineOffset">';
            html += '         <h2 class="tarteaucitronH1" role="heading" id="dialogTitle">' + tarteaucitron.lang.title + '</h2>';
            ...
            html += '         <div class="tarteaucitronName">';
            html += '            <h3 class="tarteaucitronH2" role="heading" >' + tarteaucitron.lang.all + '</h3>';
            html += '         </div>';
            ...
            html += '           <label class="tarteaucitronLabelCheckBox" for="tarteaucitronAll" tabIndex="0" onkeydown="if (event.key === \'Enter\') document.getElementById(\'tarteaucitronAll\').click();" role="switch"><span class="allowTxt">' + tarteaucitron.lang.allow + '</span><span class="denyTxt">';
            html += '           ' + tarteaucitron.lang.deny + '</span><span class="tarteaucitronCheckBoxBt"></span></label>';
            html += '       </div>';
            ...
            html += '         <div class="tarteaucitronValidation"><button class="tarteaucitronSave" onclick="tarteaucitron.userInterface.respondNone();tarteaucitron.userInterface.closePanel();">Enregistrer mes choix</button></div>';
            ...
            if (tarteaucitron.parameters.highPrivacy && !tarteaucitron.parameters.AcceptAllCta) {
                html += '<div id="tarteaucitronAlertBig" role="dialog" aria-modal="true" class="tarteaucitronAlertBig' + orientation + '" arial-label="'+tarteaucitron.lang.titleBigPrivacy+'" aria-describedby="tarteaucitronDisclaimerAlert">';
                html += '   <h2 id="tarteaucitronDisclaimerTitle">'
                html += '      ' + tarteaucitron.lang.titleBigPrivacy
                html += '   </h2>'
                ...
                html += '<div id="tarteaucitronAlertBig" role="dialog" aria-modal="true" class="tarteaucitronAlertBig' + orientation + '"arial-label="'+tarteaucitron.lang.titleBigPrivacy+'" aria-describedby="tarteaucitronDisclaimerAlert">';
                html += '   <div id="tarteaucitronAlertBigContainer">';
                ...
                html += '         <li><button id="tarteaucitronCloseAlert" onclick="tarteaucitron.userInterface.openPanel();">';
                html += '             ' + tarteaucitron.lang.personalize;
                html += '         </button></li>';
                html += '         <li><button id="tarteaucitronPersonalize2" onclick="tarteaucitron.userInterface.respondAll(false);">';
                html += '            ' + tarteaucitron.lang.denyAll2;
                html += '         </button></li>';
                html += '         <li><button id="tarteaucitronPersonalize" onclick="tarteaucitron.userInterface.respondAll(true);">';
                html += '            ' + tarteaucitron.lang.acceptAll;
                html += '         </button></li>';


                if (tarteaucitron.parameters.privacyUrl !== "") {
                    html += '   <li><button id="tarteaucitronPrivacyUrl" onclick="document.location = tarteaucitron.parameters.privacyUrl">';
                    html += '       ' + tarteaucitron.lang.privacyUrl;
                    html += '   </button></li>';
                }
            ...
            if (tarteaucitron.parameters.showAlertSmall === true) {
                ...
                if (tarteaucitron.parameters.cookieslist === true) {
                    ...
                    html += '            <h3 class="tarteaucitronH2" role="heading"  id="tarteaucitronCookiesNumberBis">0 cookie</h3>';
                    html += '       </div>';
